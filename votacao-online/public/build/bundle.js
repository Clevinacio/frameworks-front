...
var app = (function () {
    ...
    /* src\components\Cabine.svelte generated by Svelte v3.38.3 */
    const file$2 = "src\\components\\Cabine.svelte";
    ...
    // (9:2) {#each opcoes as opcao, index (opcao)}
    function create_each_block$1(key_1, ctx) {
    	let button;
    	let t0_value = /*opcao*/ ctx[2].opcao + "";
    	let t0;
    	let t1;
    	let mounted;
    	let dispose;
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			t0 = text(t0_value);
    			t1 = space();
    			attr_dev(button, "class", "svelte-mv3ilu");
    			add_location(button, file$2, 9, 4, 212);
    			this.first = button;
    		},
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			if (dirty & /*opcoes*/ 1 && t0_value !== (t0_value = /*opcao*/ ctx[2].opcao + "")) set_data_dev(t0, t0_value);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(9:2) {#each opcoes as opcao, index (opcao)}",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "options svelte-mv3ilu");
    			add_location(div, file$2, 7, 0, 143);
    		},
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ createEventDispatcher, opcoes, dispatch });
    ...
    /* src\components\Resultado.svelte generated by Svelte v3.38.3 */

    const file$1 = "src\\components\\Resultado.svelte";
    ...
    // (15:2) {#each opcoes as opcao, index (index)}
    function create_each_block(key_1, ctx) {
    	let p;
    	let t0_value = /*index*/ ctx[6] + 1 + "";
    	let t0;
    	let t1;
    	let t2_value = /*opcao*/ ctx[4].opcao + "";
    	let t2;
    	let t3;
    	let t4_value = /*opcao*/ ctx[4].count + "";
    	let t4;
    	let t5;
    	let t6_value = parseInt(/*opcao*/ ctx[4].count / /*total*/ ctx[2]() * 100) + "";
    	let t6;
    	let t7;
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			attr_dev(p, "class", "svelte-1bsn583");
    			add_location(p, file$1, 15, 4, 280);
    			this.first = p;
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			if (dirty & /*opcoes*/ 1 && t0_value !== (t0_value = /*index*/ ctx[6] + 1 + "")) set_data_dev(t0, t0_value);
    			if (dirty & /*opcoes*/ 1 && t2_value !== (t2_value = /*opcao*/ ctx[4].opcao + "")) set_data_dev(t2, t2_value);
    			if (dirty & /*opcoes*/ 1 && t4_value !== (t4_value = /*opcao*/ ctx[4].count + "")) set_data_dev(t4, t4_value);
    			if (dirty & /*opcoes*/ 1 && t6_value !== (t6_value = parseInt(/*opcao*/ ctx[4].count / /*total*/ ctx[2]() * 100) + "")) set_data_dev(t6, t6_value);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(15:2) {#each opcoes as opcao, index (index)}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "svelte-1bsn583");
    			add_location(div, file$1, 13, 0, 227);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*color, parseInt, opcoes, total*/ 7) {
    				each_value = /*opcoes*/ ctx[0];
    				validate_each_argument(each_value);
    				validate_each_keys(ctx, each_value, get_each_context, get_key);
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	const writable_props = ["opcoes", "color"];
    	...
    	$$self.$capture_state = () => ({ opcoes, color, totalVotos, total });
    	...
    	return [opcoes, color, total];
    }

    class Resultado extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$2, create_fragment$2, safe_not_equal, { opcoes: 0, color: 1 });
    ...
    /* src\components\CardVotacao.svelte generated by Svelte v3.38.3 */
    const file = "src\\components\\CardVotacao.svelte";
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 37, 4, 666);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*opcoes*/ 1) resultado_changes.opcoes = /*opcoes*/ ctx[0];
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 33, 4, 588);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*opcoes*/ 1) cabine_changes.opcoes = /*opcoes*/ ctx[0];
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div0 = element("div");
    			h2 = element("h2");
    			t0 = text(/*pergunta*/ ctx[2]);
    			t1 = space();
    			if_block.c();
    			attr_dev(h2, "class", "svelte-1wjv3op");
    			add_location(h2, file, 30, 4, 528);
    			attr_dev(div0, "class", "question svelte-1wjv3op");
    			add_location(div0, file, 29, 2, 500);
    			attr_dev(div1, "class", "container svelte-1wjv3op");
    			add_location(div1, file, 28, 0, 473);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (!current || dirty & /*pergunta*/ 4) set_data_dev(t0, /*pergunta*/ ctx[2]);
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	let { pergunta = "Nova pergunta" } = $$props;

    	let { opcoes = [
    		{ opcao: "Sim", count: 6 },
    		{ opcao: "Não", count: 5 },
    		{ opcao: "Talvez", count: 3 }
    	] } = $$props;

    	let { mode = "open" } = $$props;

    	function votar(event) {
    		$$invalidate(0, opcoes[event.detail].count += 1, opcoes);
    		$$invalidate(1, mode = "closed");
    	}

    	const writable_props = ["pergunta", "opcoes", "mode"];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<CardVotacao> was created with unknown prop '${key}'`);
    	});

    	$$self.$$set = $$props => {
    		if ("pergunta" in $$props) $$invalidate(2, pergunta = $$props.pergunta);
    		if ("opcoes" in $$props) $$invalidate(0, opcoes = $$props.opcoes);
    	...
    	return [opcoes, mode, pergunta, votar];
    }

    class CardVotacao extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { pergunta: 2, opcoes: 0, mode: 1 });
    ...
    function create_fragment(ctx) {
    	let cardvotacao;
    	let current;
    	cardvotacao = new CardVotacao({ $$inline: true });
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ CardVotacao });
    	return [];
    }
